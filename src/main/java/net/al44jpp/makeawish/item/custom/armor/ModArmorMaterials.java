...
public class ModArmorMaterials {
    public static final Holder<ArmorMaterial> WISH_ARMOR_MATERIAL = register("wish",
    ...
    private static Holder<ArmorMaterial> register(String name, EnumMap<ArmorItem.Type, Integer> typeProtection,
        ...
        ResourceLocation location = ResourceLocation.fromNamespaceAndPath(MAW.MOD_ID, name);
